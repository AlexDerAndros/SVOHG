      ...
      try {
        ...
        await addDoc(collection(db, "mail"), {
          ...
          message: {
            ...
            html: ` <div style={{fontFamily:"Arial"}}> Hallo ${mail},  <br/> <br/> sie nehmen nun am Event teil teil. <br/> 
            Falls Sie noch weitere Fragen haben, wenden Sie sich bitte an die E-Mail Adresse svohgmonheim7@gmail.com. <br/> <br/> Mit freundlichen Grüßen <br/> Eure SV </div>`,
          }
        });
...
function InEvent({ remove, events }) {
  ...
  let mail = Cookies.get("email1") || "Hier ist dasselbe der Fall.";
